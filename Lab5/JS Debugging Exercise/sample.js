...
{    
    ...
    document.getElementById("display-panel").innerHTML=evenOddFlag();
}
...
{    
    ...
    return [document.getElementById("display-panel").innerHTML="<p>Given numbers: "+evenOdd+"</p>"+"<p>Even:  "+even+" Odd: "+odd+"</p>"]
}
